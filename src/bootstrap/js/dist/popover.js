...
;(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ...
    ? define(['./dom/selector-engine', './tooltip'], factory)
    : ((global =
        typeof globalThis !== 'undefined' ? globalThis : global || self),
      (global.Popover = factory(global.SelectorEngine, global.Tooltip)))
    ...
    getTipElement() {
      ...
      if (!this.getTitle()) {
        SelectorEngine__default['default']
          .findOne(SELECTOR_TITLE, this.tip)
          .remove()
      }

      if (!this._getContent()) {
        SelectorEngine__default['default']
          .findOne(SELECTOR_CONTENT, this.tip)
          .remove()
      }
